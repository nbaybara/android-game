        ...
        new CountDownTimer(10000,1000){
           //Oyundaki süre kısmı
            public void onTick(long millisUntilFinished) {
                timeText.setText("Son: " + millisUntilFinished/1000);
            ...
            public void onFinish() {
                ...
                alert.setNegativeButton("Kendimi yormaya değmez", new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(MainActivity.this,"İşimiz bitti",Toast.LENGTH_SHORT).show();
                        Intent exitMenu = new Intent(MainActivity.this,menuPage.class);
