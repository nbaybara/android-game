...
public class level2nd extends AppCompatActivity {
    int score;
    TextView scoreText;
    TextView timeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level2nd);
        ...
        new CountDownTimer(10000,1000){
            ...
            public void onTick(long millisUntilFinished) {
                timeText.setText("Son: " + millisUntilFinished / 1000+" sn " );
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder  alert = new AlertDialog.Builder(level2nd.this);
                ...
                alert.setNegativeButton("Kendimi yormaya değmez", new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(level2nd.this,"İşimiz bitti",Toast.LENGTH_SHORT).show();
                        Intent exitMenu = new Intent(level2nd.this,menuPage.class);
